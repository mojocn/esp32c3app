...
static const RpcMethodEntry rpc_methods[] = {
    ...
    {"Config.Set", m_config_set}, {"Cron.List", m_cron_list},   {"Cron.Get", m_cron_get},       {"Cron.Create", m_cron_create},       {"Cron.Update", m_cron_update},     {"Cron.Delete", m_cron_delete},     {"Mqtt.Set", m_mqtt_set},
    {"Mqtt.Info", m_mqtt_info},
};
